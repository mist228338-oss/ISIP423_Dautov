...
namespace LibraryApp
{
    ...
    class Program
    {
        ...
        static void InitializeSampleData()
        {
            _books.AddRange(new[]
            {
                new Book("Властелин Колец", "Толкин", Genre.Фантастика, 1954, 1500),
                new Book("1984", "Оруэлл", Genre.Научная фантастика , 1949, 800),
                new Book("Убийство в Восточном экспрессе", "Кристи", Genre.Мистика, 1934, 700),
                new Book("Дюна", "Герберт", Genre.Научная фантастика , 1965, 950),
                new Book("Дракула", "Стокер", Genre. Хорор , 1897, V)
            });
        }
